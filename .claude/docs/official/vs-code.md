...
1. Open **Past Conversations** by clicking the dropdown at the top of the Claude Code panel.
2. The dialog shows two tabs: Local and Remote. Click **Remote** to see sessions from claude.ai.
3. Browse or search your remote sessions. Click any session to download it and continue the conversation locally.
