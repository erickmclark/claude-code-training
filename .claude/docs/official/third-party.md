...
**Corporate proxy** — Route Bedrock traffic through your corporate proxy:
...
**LLM Gateway** — Route Bedrock traffic through your LLM gateway:
...
**Corporate proxy** — Route Foundry traffic through your corporate proxy:
...
**LLM Gateway** — Route Foundry traffic through your LLM gateway:
...
**Corporate proxy** — Route Vertex AI traffic through your corporate proxy:
...
**LLM Gateway** — Route Vertex AI traffic through your LLM gateway:
