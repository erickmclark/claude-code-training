...
You can kick off new tasks on the web from your terminal with `--remote`, or teleport web sessions back to your terminal to continue locally. To use the web interface while running Claude Code on your own machine instead of cloud infrastructure, see [Remote Control](/en/remote-control).
...
Your `gh` credentials give Claude access to clone and push, so you can skip the GitHub App for basic sessions. Install the App later if you want Auto-fix, which uses the App to receive PR webhooks.

Team and Enterprise admins can disable terminal setup with the Quick web setup toggle at claude.ai/admin-settings/claude-code.
...
**Anthropic Services:** api.anthropic.com, statsig.anthropic.com, platform.claude.com, code.claude.com, claude.ai

**Version Control:** github.com, api.github.com, raw.githubusercontent.com, gitlab.com, bitbucket.org and related subdomains

**Container Registries:** registry-1.docker.io, gcr.io, ghcr.io, mcr.microsoft.com, public.ecr.aws

**Cloud Platforms:** *.googleapis.com, *.microsoftonline.com, *.amazonaws.com and related cloud provider domains

**Package Managers - JavaScript/Node:** registry.npmjs.org, yarnpkg.com

**Package Managers - Python:** pypi.org, files.pythonhosted.org

**Package Managers - Ruby:** rubygems.org, api.rubygems.org

**Package Managers - Rust:** crates.io, static.rust-lang.org

**Package Managers - Go:** proxy.golang.org, sum.golang.org, pkg.go.dev

**Package Managers - JVM:** repo.maven.org, plugins.gradle.org

**Package Managers - Other:** packagist.org (PHP), nuget.org (.NET), pub.dev (Dart/Flutter), hex.pm (Elixir/Erlang), cocoapods.org (iOS/macOS)

**Linux Distributions:** archive.ubuntu.com, security.ubuntu.com, ppa.launchpad.net

**Development Tools:** dl.k8s.io, releases.hashicorp.com, repo.anaconda.com, nodejs.org

**Cloud Services & Monitoring:** statsig.com, sentry.io, *.datadoghq.com

**Content Delivery & Mirrors:** sourceforge.net, packagecloud.io

**Schema & Configuration:** json-schema.org, json.schemastore.org
...
* **Platform restrictions**: Claude Code on the web only works with code hosted in GitHub. Self-hosted GitHub Enterprise Server instances are supported for Team and Enterprise plans. GitLab and other non-GitHub repositories cannot be used with cloud sessions
